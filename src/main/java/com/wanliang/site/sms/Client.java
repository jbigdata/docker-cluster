...
public class Client
{
    ...
    private String pwd = "HP0::Wuw4zk:1!n8iSwD";
    ...
    public String report(long maxid)
    {
        ...
        xml = xml + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">";
        xml = xml + "<soap:Body>";
        xml = xml + "<report xmlns=\"http://tempuri.org/\">";
        xml = xml + "<sn>" + this.sn + "</sn>";
        xml = xml + "<pwd>" + this.pwd + "</pwd>";
        xml = xml + "<maxid>" + maxid + "</maxid>";
        xml = xml + "</report>";
        xml = xml + "</soap:Body>";
        xml = xml + "</soap:Envelope>";
        try
    ...
    public static void main(String[] args) {
        try {
            //SDK-BBX-010-21771 "[-10bb-["
            Client clinet = new Client("SDK-BBX-010-21925", "ea#3-c#4");
            clinet.mt("18612302838", "【mcrio】", "", "", "");
           String msg= clinet.getBalance();
